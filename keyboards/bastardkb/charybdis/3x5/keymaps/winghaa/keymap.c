...
const uint16_t escape_combo[] PROGMEM = {SPC_NAV, TAB_FUN, COMBO_END};
const uint16_t delete_combo[] PROGMEM = {ENT_SYM, BSP_NUM, COMBO_END};
const uint16_t l_bracket_combo[] PROGMEM = {KC_Z, KC_X, COMBO_END};
const uint16_t r_bracket_combo[] PROGMEM = {KC_X, KC_C, COMBO_END};
const uint16_t l_paren_combo[] PROGMEM = {KC_C, KC_V, COMBO_END};
const uint16_t r_paren_combo[] PROGMEM = {KC_SLSH, KC_DOT, COMBO_END};
const uint16_t l_brace_combo[] PROGMEM = {KC_DOT, KC_COMM, COMBO_END};
const uint16_t r_brace_combo[] PROGMEM = {KC_COMM, KC_M, COMBO_END};
