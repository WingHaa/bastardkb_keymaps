...
#define LAYOUT_LAYER_FUNCTION                                                                 \
    ...
    ______________HOME_ROW_GACS_L______________,  KC_DEL,   KC_F4,   KC_F5,   KC_F6,  KC_F11, \
...
enum combo_events {
  ...
  SCLN_COMBO,       // LT0 and LM0 => ;
  COLN_COMBO,       // LM0 and LB0 => :
  COMBO_LENGTH
};
uint16_t COMBO_LEN = COMBO_LENGTH;

const uint16_t escape_combo[] PROGMEM = {KC_SPC, KC_TAB, COMBO_END};
const uint16_t l_bracket_combo[] PROGMEM = {KC_Q, KC_W, COMBO_END};
const uint16_t r_bracket_combo[] PROGMEM = {KC_O, KC_P, COMBO_END};
const uint16_t l_paren_combo[] PROGMEM = {KC_W, KC_E, COMBO_END};
const uint16_t r_paren_combo[] PROGMEM = {KC_I, KC_O, COMBO_END};
const uint16_t l_brace_combo[] PROGMEM = {KC_E, KC_R, COMBO_END};
const uint16_t r_brace_combo[] PROGMEM = {KC_U, KC_I, COMBO_END};
const uint16_t l_abk_combo[] PROGMEM = {KC_R, KC_T, COMBO_END};
const uint16_t r_abk_combo[] PROGMEM = {KC_U, KC_Y, COMBO_END};
const uint16_t scln_combo[] PROGMEM = {KC_V, KC_B, COMBO_END};
const uint16_t coln_combo[] PROGMEM = {KC_N, KC_M, COMBO_END};
